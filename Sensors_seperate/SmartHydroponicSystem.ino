...
void uploadDataToGoogleSheets() {
  ...
  // Print all values being sent to help debug
...
void loop() {
  ...
  // Check for control commands from Firebase every 5 milli seconds
  static unsigned long lastControlCheckTime = 0;
  if (millis() - lastControlCheckTime >= 500) {
  ...
  // Read sensors and upload data every 10 seconds
